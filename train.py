...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/origin.yaml', help='data.yaml path')
    ...
    parser.add_argument('--weights', type=str, default='/content/drive/MyDrive/yolov5-2.0/weights/yolov5s.pt', help='initial weights path')
